...
class PremiumMultiorganizationPermissions(permissions.BasePermission):
    ...
    message = "You must upgrade your Borea plan to be able to create and manage multiple organizations."
...
class OrganizationSignupSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance) -> Dict:
        ...
        data["redirect_url"] = "/ingestion" if self.enable_new_onboarding() else "/ingestion"
        return data

    ...
    if not token:
        return cors_response(
            ...
            JsonResponse(
                {
                    "code": "validation",
                    "message": "API key not provided. You can find your project API key in Borea project settings.",
                },
                status=401,
            ),
        )
        ...
        if not project_id:
            return cors_response(
                ...
                JsonResponse(
                    {
                        "code": "validation",
                        "message": "Project API key invalid. You can find your project API key in Borea project settings.",
                    },
                    status=401,
                ),
            )

...
def get_from_env(key: str, default: Any = None, *, optional: bool = False, type_cast: Optional[Callable] = None) -> Any:
    ...
    if value is None:
        ...
        if default is not None:
            ...
            raise ImproperlyConfigured(f'The environment variable "{key}" is required to run Borea!')
...
if DEBUG and not TEST:
    print_warning(
        (
            "️Environment variable DEBUG is set - Borea is running in DEVELOPMENT MODE!",
...
if not DEBUG and not TEST and SECRET_KEY == DEFAULT_SECRET_KEY:
    print_warning(
        (
            ...
            "Review the \'Generate a secret key\' portion of our README for instructions on how to secure your Borea instance"
        )
    )

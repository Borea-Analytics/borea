...
export const keyMapping = {
    event: {
        ...
        $initial_referrer: {
            ...
            examples: ['https://google.com/search?q=borea&rlz=1C...'],
        },
        ...
        $user_id: {
            ...
            description: (
                <span>
                    ...
                    <pre style={{ display: 'inline' }}>borea.identify('distinct id')</pre>. If the user is anonymous,
                    it'll be empty.
                </span>
            ),
        },
    ...
    element: {
        ...
        href: {
            ...
            examples: ['https://borea.dev/about'],
        },
    },
}

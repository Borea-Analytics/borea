...
export function DemoWarnings(): JSX.Element | null {
    ...
    const WARNINGS: WarningsInterface = {
        welcome: {
            ...
            description: (
                <span>
                    We want you to try all the power of Borea right away. Explore everything in this full-fledged demo
        ...
        incomplete_setup_on_demo_project: {
            message: `Get started using Borea, ${user?.name}!`,
            description: (
                <span>
        ...
        incomplete_setup_on_real_project: {
            message: `Finish setting up Borea, ${user?.name}!`,
            description: (
                <span>
                    You're very close. Go to <Link to="/setup">setup</Link> to finish up configuring Borea.
                </span>
            ),
            action: (
                <LinkButton

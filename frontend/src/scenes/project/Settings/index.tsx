    ...
    return (
        <div style={{ marginBottom: 128 }}>
            ...
            <Card>
                ...
                To integrate Borea into your website and get event autocapture with no additional work, include the
                following snippet in your&nbsp;website's&nbsp;HTML. Ideally, put it just above the&nbsp;
                <code>{'<head>'}</code>&nbsp;tag.
                <br />
                {/* For more guidance, including on identying users,{' '}
                <a href="https://posthog.com/docs/integrations/js-integration">see Borea Docs</a>. */}
                <JSSnippet />
                {/* <p>
                    You can even test Borea out on a live site without changing any code.
                    <br />
                    Just drag the bookmarklet below to your bookmarks bar, open the website you want to test Borea on
                    and click it.
                    <br />
                ...
                To send custom events <a href="https://posthog.com/docs/integrations">visit Borea Docs</a> and
                ...
                with Borea, so it's safe to use in public apps. */}
                <Divider />
                ...
                <p>
                    ...
                    <b>your website needs to have</b> the <a href="#snippet">Borea snippet installed.</a>
                </p>
                <SessionRecording />
                <Divider />

...
function HelperLinks(): JSX.Element {
    return (
        <>
            ...
            <a className="plain-link" href={`https://borea.dev`} rel="noopener">
                Borea Website
            </a>
            {/* <a
    ...
    return (
        <div className="authenticated-invite">
            <div className="inner">
                ...
                <div>
                    You will accept the invite under your <b>existing Borea account</b> ({user?.email})
                </div>
                ...
                <div>
                    {!acceptedInvite ? (
                        <>
                            ...
                            <div className="mt">
                                <Link to="/">
                                    <ArrowLeftOutlined /> Go back to Borea
                                </Link>
                            </div>
                        </>
                    ) : (
                        <Button block onClick={() => (window.location.href = '/')}>
                            Go to Borea <ArrowRightOutlined />
                        </Button>
                    )}
                </div>
            </div>

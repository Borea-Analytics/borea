        ...
        <div className="onboarding-setup">
            {currentSection ? (
                <>
                    <Row gutter={16}>
                        <Col span={18}>
                            <PageHeader
                                title="Setup"
                                caption="Get your Borea instance up and running with all the bells and whistles"
                            />
                        </Col>
                    ...
                    <Collapse defaultActiveKey={currentSection} expandIconPosition="right" accordion>
                        <Panel
                            header={
                                <PanelHeader
                                    ...
                                    caption="First things first, you need to connect Borea to your website. You’ll be able to add more sources later."
                                    stepNumber={1}
                                />
                            }
                            key="1"
                        ...
                        <Panel
                            header={
                                <PanelHeader
                                    title="Configuration"
                                    caption="Tune the settings of Borea to make sure it works best for you and your team."
                                    stepNumber={2}
                                />
                            }
                            key="2"
                        ...
                        >
                            <div className="step-list">
                                <OnboardingStep
                                    ...
                                    caption={<>Play user interactions as if you were right there with them .</>}
                                    customActionElement={
                                ...
                                {/* <OnboardingStep
                                    ...
                                    caption="Fastest way to reach the Borea team and the community."
                                    customActionElement={
                        ...
                        caption={
                            <div className="mb">
                                ...
                                <div className="text-muted">
                                    It’s helpful to separate your different apps in multiple projects.{' '}
                                    {/* Read more about
                ...
                <div className="already-completed">
                    ...
                    <div className="text-muted">Looks like your organization is good to go. </div>

    ...
    return (
        <div style={{ minHeight: '100vh' }}>
            <Space direction="vertical" className="space-top" style={{ width: '100%', paddingLeft: 32 }}>
                <PageHeader title="Welcome to Borea!" caption="Understand your users. Build a better product." />
            </Space>
            <Col xs={24} style={{ margin: '0 16px' }}>
                <h2 className="subtitle text-center space-top">
                    We're glad to have you here! Let's get you started with Borea.
                </h2>
            </Col>

...
const columns = [
    {
        ...
        sorter: (a: PropertyUsageType, b: PropertyUsageType) => {
            // If Borea property, put at end of list
    ...
    },
    {
        title: function QueriesTitle() {
            return (
                <Tooltip placement="right" title="Number of queries in Borea that included a filter on this property.">
    ...
    return (
        <div>
            <Button size="small" type="default" onClick={() => setShowPostHogProps(!showPostHogProps)}>
                {showPostHogProps ? 'Hide' : 'Show'} Borea properties
            </Button>
            <br />
            <br />
